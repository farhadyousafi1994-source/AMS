...
export default defineConfig((/* ctx */) => {
  return {
    ...
    boot: ['pinia', 'axios', 'i18n', 'globals', 'offline', 'pwa'],

    // https://v2.quasar.dev/quasar-cli-vite/quasar-config-file#css
    css: ['app.scss', 'brand.css'],
    ...
    extras: [
      ...
      'mdi-v7', // legacy menus/components use mdi-* icons
    ...
    build: {
      ...
      publicPath: './', // relative paths — required for Electron file:// loading
      // define: {},
      // defineEnv: {}
